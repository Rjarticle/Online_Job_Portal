...
if($UserType=="Administrator") {
    ...
    if ($records==0) {
        ...
        if ($row['Status'] != 'Confirm') {
            ...
            mysqli_query($con, "UPDATE jobseeker_reg SET Status='Confirm' WHERE UserName='".$UserName."'");
        }
    ...
    if ($records==0) {
        ...
        if ($row['Status'] != 'Confirm') {
            // Update status to Confirm
            mysqli_query($con, "UPDATE employer_reg SET Status='Confirm' WHERE UserName='".$UserName."'");
        }
